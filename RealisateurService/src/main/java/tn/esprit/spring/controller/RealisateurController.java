...
public class RealisateurController {
   ...
   /* @PutMapping(value = "/affecter/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<Realisateur> affecterfilm(@PathVariable(value = "id") int id,@RequestBody Realisateur realisateur){

        return new ResponseEntity<Realisateur>(RealisateurServices.affecterFilm(id, realisateur), HttpStatus.OK);
    }*/
}
